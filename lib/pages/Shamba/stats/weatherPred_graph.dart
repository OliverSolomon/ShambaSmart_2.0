...
class WeatherPredctionsGraph extends StatefulWidget {
  const WeatherPredctionsGraph({Key? key}) : super(key: key);

  @override
  State<WeatherPredctionsGraph> createState() => _WeatherPredctionsGraphState();
}

class _WeatherPredctionsGraphState extends State<WeatherPredctionsGraph> {
  ...
  String statName = "Weather & Predctions";
  double monValue = 0.80;
  double tueValue = 0.69;
  double wedValue = 0.20;
  double thurValue = 0.10;
  double friValue = 0.48;
  double satValue = 0.78;
  double sunValue = 0.40;
