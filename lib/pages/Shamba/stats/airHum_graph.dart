...
class AirHumGraph extends StatefulWidget {
  const AirHumGraph({Key? key}) : super(key: key);

  @override
  State<AirHumGraph> createState() => _AirHumGraphState();
}

class _AirHumGraphState extends State<AirHumGraph> {
  ...
  String statName = "Air Moisture & Humidity";
  double monValue = 0.53;
  double tueValue = 0.82;
  double wedValue = 0.47;
  double thurValue = 0.60;
  double friValue = 0.38;
  double satValue = 0.69;
