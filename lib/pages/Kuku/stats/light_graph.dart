...
class LightGraph extends StatefulWidget {
  const LightGraph({Key? key}) : super(key: key);

  @override
  State<LightGraph> createState() => _LightGraphState();
}

class _LightGraphState extends State<LightGraph> {
